...
public class AccountProjectionTest {
    ...
    public void yearRange() {
        AccountProjection accountProjection = new AccountProjection(40, new AccountYear(
                new ValidYear(2020), new Euro(10000), new Euro(3000), new Percentage(10), new Percentage(25)));
        assertEquals(new ValidYear(2060), accountProjection.lastYear());
    ...
    public void PrecisionOfCumulativeOperationsTest() {
        AccountProjection accountProjection = new AccountProjection(40, new AccountYear(new ValidYear(2020),
                new Euro(7000), new Euro(2250), new Percentage(10), new Percentage(25)));
        assertEquals(new ValidYear(2060), accountProjection.year(40).year());
